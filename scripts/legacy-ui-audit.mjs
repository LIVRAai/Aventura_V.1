...
const detail = read('nova-legacy-detail-v24-4.css');
...
const checks = [
  ...
  ['Carga detalle legacy', loader.includes("@import url('/nova-legacy-detail-v24-4.css')")],
  ...
  ['Atlas consola clara', detail.includes('#app .code-console') && detail.includes('var(--nova-brand-soft)!important')],
  ['Atlas reto final claro', detail.includes('#app .boss-card')],
  ['Atlas feedback NOVA claro', detail.includes('#app .nova-feedback-card')],
  ...
  ['Cuaderno microestados legibles', detail.includes('#notebookModule .procedure-step.active small') && detail.includes('#notebookModule .procedure-step.done small')],
