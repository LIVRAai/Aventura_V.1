...
const checks = [
  ...
  ['Carga V27 después de V26', loader.includes("load('/app-v26.js', () => load('/app-v27.js'))")],
  ...
  ['V26 visualmente suprimida al activar V27', css.includes('#v26GameScene') && css.includes('#v26TopicScene')],
