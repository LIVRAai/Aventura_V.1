...
const intent = read('app-v27-intent.js');
const guardian = read('app-v27-coherence-guardian.js');
...
const checks = [
  ...
  ['Cadena V27 completa: motor → intención → guardián', loader.includes("load('/app-v27.js'") && loader.includes("load('/app-v27-intent.js'") && loader.includes("load('/app-v27-coherence-guardian.js'")],
  ...
  ['Preload de capas críticas', loader.includes("link.rel = 'preload'") && loader.includes("'/app-v27.js'") && loader.includes("'/app-v27-coherence-guardian.js'")],
  ...
  ['Motor de intención usa pregunta y opciones', intent.includes('cleanQuestion') && intent.includes('options') && intent.includes('initial-sound') && intent.includes('order-asc')],
  ['Guardián impide escenas ajenas', guardian.includes('NOVACoherenceGuardian') && guardian.includes('v27Strict') && guardian.includes('language-safe') && guardian.includes('science-safe') && guardian.includes('social-safe') && guardian.includes('english-safe') && guardian.includes('math-safe')],
  ['Fallback coherente usa solo pregunta y opciones', guardian.includes('La escena usa únicamente información de este reto.') && guardian.includes('c.prompt') && guardian.includes('buttons(c)')],
  ...
  ['Reduced motion preservado', css.includes('prefers-reduced-motion:reduce') && guardian.includes('prefers-reduced-motion:reduce')],
...
let failed=false;
console.log('\nNOVA V27 · visual-first + strict coherence audit\n');
