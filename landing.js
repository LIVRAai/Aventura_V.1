(() => {
  ...
  analytics.src = '/analytics-client.js';
  analytics.async = false;
  analytics.onload = () => window.NOVAAnalytics?.track?.('landing_view', {}, 'landing');
  ...
  const scenes = [
    { kicker:'UNA DUDA', title:'“No entiendo esta división.”', text:'864 ÷ 4', message:'No te voy a dar la respuesta. Vamos a descubrirla juntos.' },
    { kicker:'NOVA ACOMPAÑA', title:'Empecemos por una sola idea.', text:'¿Cuántas veces cabe 4 en 8?', message:'Piensa en la tabla del 4. ¿Qué número multiplicado por 4 nos acerca exactamente a 8?' },
    { kicker:'EL NIÑO RAZONA', title:'4 × 2 = 8', text:'Entonces escribo 2.', message:'Eso es. Ya descubriste el primer paso tú mismo. Ahora podemos continuar desde ahí.' },
    { kicker:'COMPRENSIÓN', title:'“Ahora sí lo entiendo.”', text:'+80 XP · Misión completada', message:'No memorizaste una respuesta: entendiste cómo encontrarla.' }
  ];
  ...
  function renderScene(nextIndex, userInitiated = false) {
    ...
    window.setTimeout(() => {
      ...
      nextBtn.innerHTML = index === scenes.length - 1 ? 'Ver de nuevo <span>↻</span>' : 'Siguiente <span>→</span>';
